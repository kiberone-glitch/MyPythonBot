...
def callback2 (call2):
    if call2.data == "about":
        ...
        bot.send_chat_action (call2.message.chat.id, 'typing')
        time.sleep (2)
        bot.send_message (call2.message.chat.id, "Этот бот был сделан Егором 14.03.26. Бот был написан на python. Хостится на Railway. Также есть репозиторий на Github.")
